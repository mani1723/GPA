...
public class ClassDataSource {
	...
	private Class cursorToClass(Cursor cursor) {
		...
		scaleobj.setA(cursor.getInt(4));
		scaleobj.setA_minus(cursor.getInt(5));
		scaleobj.setB_plus(cursor.getInt(6));
		scaleobj.setB(cursor.getInt(7));
		scaleobj.setB_minus(cursor.getInt(8));
		scaleobj.setC_plus(cursor.getInt(9));
		scaleobj.setC(cursor.getInt(10));
		scaleobj.setC_minus(cursor.getInt(11));
		scaleobj.setD_plus(cursor.getInt(12));
		scaleobj.setD(cursor.getInt(13));
		scaleobj.setD_minus(cursor.getInt(14));
